    ...
    <main className="min-h-screen px-6 py-24">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mt-20">
          ...
          <a
            href="/community"
            className="inline-block mt-6 bg-[#16A34A] px-6 py-3 rounded-xl font-medium transition-all duration-300 hover:bg-green-600 hover:scale-105 hover:shadow-lg hover:shadow-green-500/30"</a>
            Join Community
          </a>
